% Loads aggregated REAL DATA forecast metrics and exports relative bar data
% to a single CSV combining fixedbaseline=true and fixedbaseline=false rows.
%
...
%% --- Parameters ---
metrics_file_path = 'Forecasts_groups/0430_all_real_forecast_metrics.mat';
out_path          = 'Output/rel_bars_real.csv';
